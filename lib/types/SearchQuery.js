...
var SearchQuery = /** @class */ (function () {
    ...
    /**
      * @return {Array} array of applied filters objects
      */
    SearchQuery.prototype.getAppliedPostFilters = function () {
    ...
    /**
      ...
      * @return {Object}
      */
    SearchQuery.prototype.applyPostFilter = function (_a) {
        var key = _a.key, value = _a.value, _b = _a.scope, scope = _b === void 0 ? 'catalog' : _b, _c = _a.options, options = _c === void 0 ? Object : _c;
    ...
    SearchQuery.prototype.addAvailableFilter = function (_a) {
        var field = _a.field, _b = _a.type, type = _b === void 0 ? "terms" : _b, label = _a.label, _c = _a.size, size = _c === void 0 ? 10 : _c, _d = _a.options, options = _d === void 0 ? {} : _d;
