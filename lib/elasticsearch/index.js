...
function buildQueryBodyFromFilterObject(_a) {
    var config = _a.config, queryChain = _a.queryChain, filter = _a.filter, postFilter = _a.postFilter, availableFilter = _a.availableFilter, sort = _a.sort, _b = _a.search, search = _b === void 0 ? '' : _b;
    return __awaiter(this, void 0, void 0, function () {
        ...
        var appliedFilters, attribute, processedFilter, appliedAttributeValue, scope, appliedPostFilters, attribute, processedFilter, appliedAttributeValue, scope, availableFilters, attribute, scope, appliedSport, sortOption;
        return __generator(this, function (_c) {
            ...
            appliedPostFilters = [];
            if (postFilter) {
                for (attribute in postFilter) {
                    processedFilter = processNestedFieldFilter(attribute, postFilter[attribute]);
                    appliedAttributeValue = processedFilter['value'];
                    scope = 'catalog';
                    delete appliedAttributeValue.scope;
            ...
            availableFilters = [];
            if (availableFilter) {
                for (attribute in availableFilter) {
                    scope = 'catalog';
