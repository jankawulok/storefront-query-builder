...
function buildQueryBodyFromFilterObject(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        var appliedFilters, attribute, processedFilter, appliedAttributeValue, scope, appliedPostFilters, attribute, processedFilter, appliedAttributeValue, scope, availableFilters;
        return __generator(this, function (_c) {
            ...
            availableFilters = [];
            availableFilter.forEach(function (attribute) {
                var scope = 'catalog';
